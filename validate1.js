$(document).ready(function() 
{
	...
	$("#confirm_password").after("<span>Required Field.</span>");
	...
	$('#confirm_password').focus('input', function() 
	{
	$(this).next("span").text("Required Field (Enter same as password)").addClass("info").show();
	});
 ...
 $('#confirm_password').blur('input', function() 
    ...
    var pass=input_pass.val();
		...
		{
			$(this).next("span").text("Enter same as password");
			$(this).next("span").show().addClass("error");
		}
	});
